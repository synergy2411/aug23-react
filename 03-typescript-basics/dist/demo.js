...
// GENERICS
function insertAtBeginning(val, arr) {
    return [val, ...arr];
}
// const stringArr = insertAtBeginning("Jack", ["Jenny", "John"]);
let stringArr = insertAtBeginning("Jack", ["Jenny", "Jill"]);
let numberArr = insertAtBeginning(101, [102, 103, 104]);
let userOne = {
    email: "john@test",
    age: 32,
};
...
const newUserArray = insertAtBeginning(userOne, userArray);
class Employee {
...
let john = new Employee("S001", "John Doe", 32);
let serverOne = {
    resourceId: 101,
